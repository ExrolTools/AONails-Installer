...
## ⚖️ License
This software and its associated assets are proprietary. Redistribution, unauthorized sharing, modification, or asset extraction is strictly prohibited. For full details, please read the included **[LICENSE.md](https://github.com/ExrolTools/AONails-Installer?tab=License-1-ov-file)**.
...
詳細については同梱されている [LICENSE.md](https://github.com/ExrolTools/AONails-Installer?tab=License-1-ov-file)**.
 をご確認ください。
